...
Section algebra.
  ...
  | snap_master_disjoint cs1 cs2:
      Refine snapshot cs1 ⊥ Refine master (cs1 ++ cs2)
  | master_snapshot_disjoint cs1 cs2:
      Refine master (cs1 ++ cs2) ⊥ Refine snapshot cs1.
  ...
  Instance refine_op : Op (refine_car K) :=
    ...
    match le_dec (length (cfgs r1)) (length (cfgs r2)) with
      | left _ => Refine (max_view (refine_view r1) (refine_view r2)) (cfgs r2)
      | right _ => Refine (max_view (refine_view r1) (refine_view r2)) (cfgs r1)
    end.
